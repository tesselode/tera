...
local function draw_fancy_number(n, x, y, pad, alternate_palette)
	...
	local number_string = tostr(n)
	if pad then
		while #number_string < pad do
			number_string = '0' .. number_string
		end
	end
	for i = 1, #number_string do
		local pos = #number_string - (i - 1)
		local digit = tonum(sub(number_string, pos, pos))
		spr(start_sprite + digit, x - 6 * i, y)
	end
end
...

__label__
